...
router.get('/me', requireAuth, (req, res) => {
  const records = getLikedByUser(req.user.id);
...
router.get('/:trackId', requireAuth, (req, res) => {
  const record = findByUserAndTrack(req.user.id, req.params.trackId);
...
router.post('/:trackId', requireAuth, (req, res) => {
  ...
  const existing = findByUserAndTrack(req.user.id, req.params.trackId);
...
router.delete('/:trackId', requireAuth, (req, res) => {
  removeLike(req.user.id, req.params.trackId);
